...
//     myCanvas.hide();
//     soundInputField = createInput("It is a sunny day in NYC. As I am cooking, I am in a happy mood.");
...
function generateMadLib() {
    ...
    var madLibStory =     "It is a " + weather + " day in " + location + ". As I am " + action + ", I am in a " + emotion + " mood."
